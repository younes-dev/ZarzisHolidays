...
class SqlFormatterTest extends PHPUnit_Framework_TestCase {
	...
	function testUsePre() {
		...
		$expected = '<span style="color: rgb(221, 157, 147);">test</span>';
		$this->assertEquals($actual,$expected);
		
		SqlFormatter::$use_pre = true;
		$actual = SqlFormatter::highlight("test");
		$expected = '<pre style="color: black; background-color: white;"><span style="color: rgb(221, 157, 147);">test</span></pre>';
		$this->assertEquals($actual,$expected);
	}
