...
/* user/new.html.twig */
class __TwigTemplate_fa15b1a322d1f0eed303d92c948e38717e769bf02c7238355a0eaa498f07f2e8 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo "
                ";
        // line 18
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "nom", [], "any", false, false, false, 18), 'row');
        echo "
                ";
        // line 19
        ...
        echo "
                ";
        // line 23
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "retypePassword", [], "any", false, false, false, 23), 'row');
        echo "
                ";
        // line 24
        ...
        echo "
                ...
                ";
        // line 26
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 26, $this->source); })()), "roles", [], "any", false, false, false, 26), 'row', ["attr" => ["class" => "hidden"], "label" => false]);
        echo "

                ";
        // line 28
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 28, $this->source); })()), "createdAt", [], "any", false, false, false, 28), 'row');
        echo "
                ";
        // line 29
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 29, $this->source); })()), "updatedAt", [], "any", false, false, false, 29), 'row');
        echo "
...
";
    ...
    {
        return array (  165 => 37,  161 => 35,  156 => 32,  152 => 31,  147 => 29,  143 => 28,  138 => 26,  133 => 24,  129 => 23,  125 => 22,  121 => 21,  117 => 20,  113 => 19,  109 => 18,  105 => 17,  100 => 16,  97 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{#                {{ include('user/_form.html.twig') }}#}
                ...
                {{ (form_row(form.roles, {'attr': {'class': 'hidden'},'label':false } )) }}
...
{% endblock %}
", "user/new.html.twig", "/application/templates/user/new.html.twig");
    }
}
